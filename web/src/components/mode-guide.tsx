...
type Mode = { id: string; name: string; tagline: string; when: string[]; how: string[] };
...
const MODES: Mode[] = [
  ...
  },
  {
    ...
    how: [
      ...
      "20분 동안만 열리는 링크가 만들어지고, 링크를 연 사람과 AI는 같은 화면을 시간순으로 봅니다.",
      "20분이 지나면 자동으로 만료되고, 그 전에 직접 삭제할 수도 있습니다.",
    ],
  },
  {
    id: "folder",
